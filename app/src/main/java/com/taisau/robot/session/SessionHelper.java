package com.taisau.robot.session;
...
import com.taisau.robot.contact.activity.RobotProfileActivity;
import com.taisau.robot.contact.activity.UserProfileActivity;
import com.taisau.robot.redpacket.NIMRedPacketClient;
import com.taisau.robot.session.action.AVChatAction;
import com.taisau.robot.session.action.FileAction;
import com.taisau.robot.session.action.GuessAction;
import com.taisau.robot.session.action.RTSAction;
import com.taisau.robot.session.action.RedPacketAction;
import com.taisau.robot.session.action.SnapChatAction;
import com.taisau.robot.session.action.TeamAVChatAction;
import com.taisau.robot.session.action.TipAction;
import com.taisau.robot.session.activity.MessageHistoryActivity;
import com.taisau.robot.session.activity.MessageInfoActivity;
import com.taisau.robot.session.extension.CustomAttachParser;
import com.taisau.robot.session.extension.CustomAttachment;
import com.taisau.robot.session.extension.GuessAttachment;
import com.taisau.robot.session.extension.RTSAttachment;
import com.taisau.robot.session.extension.RedPacketAttachment;
import com.taisau.robot.session.extension.RedPacketOpenedAttachment;
import com.taisau.robot.session.extension.SnapChatAttachment;
import com.taisau.robot.session.extension.StickerAttachment;
import com.taisau.robot.session.search.SearchMessageActivity;
import com.taisau.robot.session.viewholder.MsgViewHolderAVChat;
import com.taisau.robot.session.viewholder.MsgViewHolderDefCustom;
import com.taisau.robot.session.viewholder.MsgViewHolderFile;
import com.taisau.robot.session.viewholder.MsgViewHolderGuess;
import com.taisau.robot.session.viewholder.MsgViewHolderOpenRedPacket;
import com.taisau.robot.session.viewholder.MsgViewHolderRTS;
import com.taisau.robot.session.viewholder.MsgViewHolderRedPacket;
import com.taisau.robot.session.viewholder.MsgViewHolderSnapChat;
import com.taisau.robot.session.viewholder.MsgViewHolderSticker;
import com.taisau.robot.session.viewholder.MsgViewHolderTip;
...
//            p2pCustomization.backgroundUri = "android.resource://com.taisau.robot/drawable/bk"
