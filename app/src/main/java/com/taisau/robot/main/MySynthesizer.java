...
import com.taisau.robot.utils.MainHandlerConstant;
...
public class MySynthesizer implements MainHandlerConstant {
    ...
    public MySynthesizer(Context context, InitConfig initConfig, Handler mainHandler) {
        this(context, mainHandler);
        init(initConfig);
    }


    protected MySynthesizer(Context context, Handler mainHandler) {
        if (isInitied) {
